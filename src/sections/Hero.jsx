     ...
     justify-center items-start w-full max-xl:padding x pt-28"
      >
        ...
        >
          ...
          <br />
          <span className="text-coral-red inline-block pt-3">Nike</span> Shoes
        </h1>
        <p
        ...
        sm:max-w-sm"
        >
          Discover stylish Nke arrivals,quality comfort and innovation for your
          active life
        </p>
      ...
      <div
        className="relative flex-1 flex justify-center items-center xl:min-h-scrren
      max-xl:py40 bg-primary bg-hero bg-cover bg-center"
      >
        <img
          src={bigShoeImg}
          alt="shoe collection"
